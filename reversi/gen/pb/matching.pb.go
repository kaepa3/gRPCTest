...
const (
	...
	JoinRoomResponse_WAITNG  JoinRoomResponse_Status = 1
...
var file_matching_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xb7, 0x01, 0x0a, 0x10, 0x4a, 0x6f, 0x69, 0x6e,
	...
	,
}
...
var file_matching_proto_depIdxs = []int32{
	...
	1, // 5: game.MatchintService.JoinRoom:input_type -> game.JoinRoomRequest
	2, // 6: game.MatchintService.JoinRoom:output_type -> game.JoinRoomResponse
...
// MatchintServiceClient is the client API for MatchintService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type MatchintServiceClient interface {
	JoinRoom(ctx context.Context, in *JoinRoomRequest, opts ...grpc.CallOption) (MatchintService_JoinRoomClient, error)
}

type matchintServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewMatchintServiceClient(cc grpc.ClientConnInterface) MatchintServiceClient {
	return &matchintServiceClient{cc}
}

func (c *matchintServiceClient) JoinRoom(ctx context.Context, in *JoinRoomRequest, opts ...grpc.CallOption) (MatchintService_JoinRoomClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MatchintService_serviceDesc.Streams[0], "/game.MatchintService/JoinRoom", opts...)
	if err != nil {
		return nil, err
	}
	x := &matchintServiceJoinRoomClient{stream}
...
type MatchintService_JoinRoomClient interface {
	Recv() (*JoinRoomResponse, error)
	grpc.ClientStream
}

type matchintServiceJoinRoomClient struct {
	grpc.ClientStream
}

func (x *matchintServiceJoinRoomClient) Recv() (*JoinRoomResponse, error) {
...
// MatchintServiceServer is the server API for MatchintService service.
type MatchintServiceServer interface {
	JoinRoom(*JoinRoomRequest, MatchintService_JoinRoomServer) error
}

// UnimplementedMatchintServiceServer can be embedded to have forward compatible implementations.
type UnimplementedMatchintServiceServer struct {
}

func (*UnimplementedMatchintServiceServer) JoinRoom(*JoinRoomRequest, MatchintService_JoinRoomServer) error {
	return status.Errorf(codes.Unimplemented, "method JoinRoom not implemented")
}

func RegisterMatchintServiceServer(s *grpc.Server, srv MatchintServiceServer) {
	s.RegisterService(&_MatchintService_serviceDesc, srv)
}

func _MatchintService_JoinRoom_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(JoinRoomRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(MatchintServiceServer).JoinRoom(m, &matchintServiceJoinRoomServer{stream})
}

type MatchintService_JoinRoomServer interface {
	Send(*JoinRoomResponse) error
	grpc.ServerStream
}

type matchintServiceJoinRoomServer struct {
	grpc.ServerStream
}

func (x *matchintServiceJoinRoomServer) Send(m *JoinRoomResponse) error {
	return x.ServerStream.SendMsg(m)
}

var _MatchintService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "game.MatchintService",
	HandlerType: (*MatchintServiceServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "JoinRoom",
			Handler:       _MatchintService_JoinRoom_Handler,
			ServerStreams: true,
		},
	},
