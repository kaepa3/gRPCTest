...
module Pancake
  module Baker
    ...
    BakeResponce = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pancake.baker.BakeResponce").msgclass
    ReportRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pancake.baker.ReportRequest").msgclass
    ReportResponce = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pancake.baker.ReportResponce").msgclass
  end
end
